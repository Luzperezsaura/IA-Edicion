...
# =====================================================================
# --- CONFIGURACIÓN: PLANO ANTERIOR IZQUIERDO (ANTEPIÉ) ---
# =====================================================================
...
OUTPUT_DIR = 'C:/Users/mluzp/Desktop/Proyecto IA/dataset_antepie_izq'

# Orígenes de datos 
FUENTES_DATOS = [
    {
        'prefix': 'vluro', 
        'csv_path': 'E:/Extraccion_VLuro/tmAntepieIzq/etiquetas.csv',
        'images_dir': 'E:/Extraccion_VLuro/tmAntepieIzq'
    },
    {
        'prefix': 'belgr', 
        'csv_path': 'E:/Extraccion_Belgrano/tmAntepieIzq/etiquetas.csv',
        'images_dir': 'E:/Extraccion_Belgrano/tmAntepieIzq'
    }
]
...
def process_dataset():
    ...
    print("¡Dataset YOLO de Antepié (Izquierdo) creado exitosamente!")
