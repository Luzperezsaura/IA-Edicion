...
# =====================================================================
# --- CONFIGURACIÓN: PLANO SAGITAL (ARCO INTERNO) ---
# =====================================================================
...
OUTPUT_DIR = 'C:/Users/mluzp/Desktop/Proyecto IA/dataset_sagital'

# Orígenes de datos (Acá vas a sumar las rutas de tu pendrive cuando vuelvas)
FUENTES_DATOS = [
    {
        'prefix': 'belgrano', # Prefijo para la clínica de Villa Luro
        'csv_path': 'C:/Users/mluzp/Desktop/Proyecto IA/IMAGENES FOOTX IA - 1 VO/tmArcoInterno/etiquetas.csv',
        'images_dir': 'C:/Users/mluzp/Desktop/Proyecto IA/IMAGENES FOOTX IA - 1 VO/tmArcoInterno/'
    },
    {
        'prefix': 'vluro', # Prefijo para la clínica de Belgrano
        'csv_path': 'C:/Users/mluzp/Desktop/imagenesia/tmArcoInterno/etiquetas.csv',
        'images_dir': 'C:/Users/mluzp/Desktop/imagenesia/tmArcoInterno'
    }
]
...
def process_dataset():
    ...
    print("¡Dataset YOLO de Arco Interno creado exitosamente!")
