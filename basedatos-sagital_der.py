...
# =====================================================================
# --- CONFIGURACIÓN: PLANO SAGITAL DERECHO (ARCO INTERNO) ---
# =====================================================================
...
OUTPUT_DIR = 'C:/Users/mluzp/Desktop/Proyecto IA/dataset_sagital_der'
...
FUENTES_DATOS = [
    {
        ...
        'csv_path': 'E:/Extraccion_VLuro/tmArcoInterno_Der/etiquetas.csv',
        'images_dir': 'E:/Extraccion_VLuro/tmArcoInterno_Der'
    },
    {
        'prefix': 'belgr', # Prefijo para la clínica de Belgrano
        'csv_path': 'E:/Extraccion_Belgrano/tmArcoInterno_Der/etiquetas.csv',
        'images_dir': 'E:/Extraccion_Belgrano/tmArcoInterno_Der'
    }
]
...
def process_dataset():
    ...
    print("¡Dataset YOLO de Arco Interno (Derecho) creado exitosamente!")
